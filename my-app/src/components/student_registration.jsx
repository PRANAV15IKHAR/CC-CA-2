...
useEffect(() => {
  ...
  async function  Load()
  {
     const result = await axios.get(
         "https://pranavbackendrepo2.onrender.com/api/v1/student/getall");
    ...
    try
        {
         await axios.post("https://pranavbackendrepo2.onrender.com/api/v1/student/save",
        {
   ...
   {
        await axios.delete("https://pranavbackendrepo2.onrender.com/api/v1/student/delete/" + studentid); 
   ...
   try
       {
        await axios.put("https://pranavbackendrepo2.onrender.com/api/v1/student/edit/" + studentid ,
       {
